                ...
                <div class="page-header-toolbar">
                  ...
                  <div class="filter-wrapper">
                    <div class="dropdown toolbar-item">
                      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownsorting" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">All Day</button>
                  ...
                  <div class="sort-wrapper">
                    ...
                    <div class="dropdown ms-lg-auto ms-3 toolbar-item">
                      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownexport" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Export</button>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-lg-row">
                      ...
                      <ul class="nav nav-tabs sales-mini-tabs ms-lg-auto mb-4 mb-md-0" role="tablist">
                        <li class="nav-item">
                          <a class="nav-link active" id="sales-statistics_switch_1" data-bs-toggle="tab" role="tab" aria-selected="true">1D</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="sales-statistics_switch_2" data-bs-toggle="tab" role="tab" aria-selected="false">5D</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="sales-statistics_switch_3" data-bs-toggle="tab" role="tab" aria-selected="false">1M</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="sales-statistics_switch_4" data-bs-toggle="tab" role="tab" aria-selected="false">1Y</a>
                        </li>
                      </ul>
                    </div>
                    <div class="d-flex flex-column flex-lg-row">
                      <div class="data-wrapper d-flex mt-2 mt-lg-0">
                        <div class="wrapper pe-5">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <small class="ms-2 text-gray d-none d-lg-block"><b>89.5%</b> of 20,000 Total</small>
                          </div>
                        </div>
                        <div class="wrapper">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <small class="ms-2 text-gray d-none d-lg-block"><b>10.5%</b> of 20,000 Total</small>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between w-100">
                          ...
                          <div class="dropdown">
                            <button class="btn btn-outline-secondary dropdown-toggle" type="button" id="dateSorter" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">This Month</button>
                        ...
                        <div class="d-flex align-items-end">
                          ...
                          <p class="mb-0 font-weight-medium me-2 ms-2 mb-1">USD</p>
                        ...
                        <div class="row mt-5">
                          <div class="col-6">
                            <div class="d-flex align-items-center mb-2">
                              <div class="icon-holder bg-primary text-white py-1 px-3 rounded me-2">
