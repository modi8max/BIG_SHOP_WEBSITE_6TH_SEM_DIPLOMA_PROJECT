              ...
              <div class="auto-form-wrapper">
                <div ="#">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                        <%--OnTextChanged="upass_TextChanged--%>
                  ...
                  <div class="form-group">
<asp:Button Text="Login" cssclass="btn btn-primary submit-btn btn-block" id="login" runat="server"  CausesValidation="False"
                                    OnClientClick="javascript:var agree=confirm('Are you Sure.');if (agree)return true ;else return false ;"
                                  />
                      <%--<asp:LinkButton ID="LinkButton2" runat="server" onclick="LinkButton2_Click">Click Me </asp:LinkButton>--%>
                      <%--<asp:Button Text="Clear" cssclass="btn btn-primary submit-btn btn-block" id="Button2" runat="server" />--%>
          <asp:Label ID="Label1" runat="server" ForeColor="red"   text=" "  OnTextChanged="upass_TextChanged"></asp:Label>          
                  </div>
